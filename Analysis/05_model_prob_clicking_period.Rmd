...
For computational efficiency, the data was sub-sampled considering a systematic sampling with random start, selecting only one out of every 10 rows in the original data. 
...
datat1$whale<-factor(datat1$whale,levels=c("Freya","Thora","Mára","Frida","Eistla","Balder","Jonas","Mutti"))
